...
import { MdShoppingCart, MdBookmarkRemove } from "react-icons/md";
...
const Navbar = () => {
  ...
  <div className="navbar-start">
    ...
    <div className="dropdown">
      ...
      <li>
        <NavLink className={({isActive})=>(isActive? 'text-indigo-600': '')} to='/favourites'><MdBookmarkRemove size={20} /></NavLink>
    </li>
      </ul>
    </div>

    <Link to='/' className="font-bold text-xl">FagshipFaceOff</Link>
